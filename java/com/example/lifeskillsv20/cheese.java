...
public class cheese extends AppCompatActivity {
    ...
    private Button cheese2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cheese);
        cheese1 = findViewById(R.id.imageView18);
        cheese1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        cheese2 = findViewById(R.id.Menu);
        cheese2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
